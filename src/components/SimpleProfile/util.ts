...
// Profile is generated by calculating offset from a circle of the desired radius. Instead of recalculating
// profile every time from scratch, we can generate template profile and derive other ones from it.
